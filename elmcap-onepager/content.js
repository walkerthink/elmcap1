...
const SITE_CONTENT = {
  ...
  brandName: "Elm Capital",
      ...
      // --- Main paragraphs ---
      intro1: "Elm Capital is a crypto liquid fund founded by a team of quantitative traders with a proven record of delivering exceptional results in traditional and digital markets. Our mission is to bring institutional-grade discipline, risk management, and execution capabilities to the rapidly evolving world of digital assets.",

      intro2: "We operate two distinct yet complementary strategies:",

      // --- Alpha Fund section ---
      alphaTitle: "Alpha Fund",
      alphaBody: "Designed to deliver consistent, high-Sharpe returns with minimal correlation to broader market movements. Through advanced statistical models, proprietary execution algorithms, and deep understanding of market microstructure, we capture inefficiencies across multiple venues and blockchains while maintaining tight risk controls.",
      ...
      philosophy: "Our investment philosophy is rooted in precision, adaptability, and the belief that combining systematic discipline with targeted thematic investing creates a resilient and scalable portfolio. By pairing the speed and accuracy of quantitative trading with the vision and flexibility of venture-style investing, Elm Capital seeks to generate superior risk-adjusted returns across market cycles.",
